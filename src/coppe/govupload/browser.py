...
from coppe.govupload.interfaces import IUploadBrowserLayer, IUploadSettings
# from coppe.govupload.behaviors import IMultipleUpload
...
from coppe.govupload.config import IMAGE_MIMETYPES
...
class Coppe_Media_Uploader(grok.View):
    ...
    grok.require('coppe.govupload.UploadFiles')
    ...
    def __call__(self, *args, **kwargs):
        ...
        if hasattr(self.request, "REQUEST_METHOD"):
            ...
            if self.request["REQUEST_METHOD"] == "POST":
                ...
                return json_view()
        return super(Coppe_Media_Uploader, self).__call__(*args, **kwargs)
...
class JSON_View(grok.View):
    ...
    def getContextInfo(self, context=None):
        ...
        if hasattr(context, 'size'):
            ...
            if context_type == 'ArquivoBiblioteca':
