...
from coppe.govupload import config
from coppe.govupload.config import PROJECTNAME
from coppe.govupload.interfaces import IUploadSettings
from coppe.govupload.testing import INTEGRATION_TESTING

BASE_REGISTRY = 'coppe.govupload.controlpanel.IuploadSettings.%s'
